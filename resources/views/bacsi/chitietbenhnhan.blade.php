                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        ...
                        <div class="el-card-item">
                                <div class="el-card-avatar el-overlay-1"><img id="imgSmile" style="width:200px; height:150px" src="{{asset('./uploads/benhan/'.$BN->hinh)}}" />

                                        <ul class="list-style-none el-info">
                                            <li class="el-item"><a class="btn default btn-outline image-popup-vertical-fit el-link" href="{{asset('./uploads/benhan/'.$BN->hinh)}}"><i class="mdi mdi-magnify-plus"></i></a></li>
                                        </ul>
                                </div>
                             </div>
