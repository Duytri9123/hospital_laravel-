                        ...
                        <script>
                            function vn() {
                                ...
                                fetch('https://corona.lmao.ninja/v2/countries/vn')
                                    ...
                                    .then((data) => {
                                        x.innerHTML = `<td class="genric-btn danger circle">Việt Nam</td>
                            ...
                            function tg() {
                                ...
                                fetch('https://disease.sh/v3/covid-19/all')
                                    ...
                                    .then((data) => {
                                        x.innerHTML = `<td class="genric-btn warning circle">Thế giới</td>
                                        <td style="color: red;">${data.cases}</td>
                                    <td style="color: orange;">${data.active}</td>
                                    <td style="color: green;">${data.recovered}</td>
                                    <td style="color: gray;">${data.deaths}</td>`;
            ...
            <div class="col-lg-6 col-md-10">
                <div class="about-caption mb-50">
                    ...
                    <div class="section-tittle section-tittle2 mb-35">
                        ...
                        <img style="padding-left:40px ;" height="200px" width="400px" src="{{asset('frontend/img/logo/5.png')}}" alt="">
                    </div>
...
*************/
            ...
            if (!$taikhoan) { ?>
                ...
                <div class=popup id="popup" style=display:none;>
                    <div class=popup-inner>
                        ...
                        <img style="padding-left:40px ;" height="200px" width="400px" src="{{asset('frontend/img/logo/QR.png')}}" alt="">
                        <input type=button name=Close class=s3-btn-close onclick=popupClose() value=&times;>
                    </div>
                </div>
            <?php
        ...
        <div class="about-area ">
            <iframe src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d15671.846569277608!2d106.6409201!3d10.8905197!3m2!1i1024!2i768!4f13.1!5e0!3m2!1svi!2s!4v1623338143080!5m2!1svi!2s" width="100%" height="500" style="border:0; padding-left: 2rem ; padding-right: 2rem;" allowfullscreen="" loading="lazy"></iframe>
        </div>
        <!-- About  End-->
